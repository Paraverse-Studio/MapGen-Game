...
namespace Paraverse.Combat
{
  public class DualAttackSkill : MobSkill, IMobSkill
  {
    ...
    public override void ActivateSkill(MobCombat mob, Animator anim, MobStats stats, Transform target = null)
    {
      ...
      mainHandAttackCollider.GetComponent<AttackCollider>().Init(mob, scalingStatData);
      offHandAttackCollider.GetComponent<AttackCollider>().Init(mob, scalingStatData);
    }
    ...
    protected override void OnSkillComplete()
    {
      ...
      DisableOffHandCollider();
      DisableMainHandCollider();
    }
    #endregion
  }
}