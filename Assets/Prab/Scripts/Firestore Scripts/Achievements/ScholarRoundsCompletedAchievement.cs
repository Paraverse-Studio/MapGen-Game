...
[Serializable]
public class ScholarRoundsCompletedAchievement
{
    ...
    public ScholarRoundsCompletedAchievement()
    {
    }

    public ScholarRoundsCompletedAchievement(int currValue)
    {
    ...
    public ScholarRoundsCompletedAchievement(AchievementsModel oldModel, SessionDataModel sessionData)
    {
        int RoundNumberCompleted = sessionData.RoundNumberReached - 1;
        CompletedCount = oldModel.ScholarRoundsCompletedAchievement.CompletedCount;
        if (sessionData.BloodLineEnum.Equals(BloodlineType.Scholar))
