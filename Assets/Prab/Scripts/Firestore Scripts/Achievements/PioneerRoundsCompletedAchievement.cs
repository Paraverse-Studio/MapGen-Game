...
[Serializable]
public class PioneerRoundsCompletedAchievement
{
    ...
    public PioneerRoundsCompletedAchievement()
    {
    }

    public PioneerRoundsCompletedAchievement(int currValue)
    {
    ...
    public PioneerRoundsCompletedAchievement(AchievementsModel oldModel, SessionDataModel sessionData)
    {
        int RoundNumberCompleted = sessionData.RoundNumberReached - 1;
        CompletedCount = oldModel.PioneerRoundsCompletedAchievement.CompletedCount;
        if (sessionData.BloodLineEnum.Equals(BloodlineType.Pioneer))
