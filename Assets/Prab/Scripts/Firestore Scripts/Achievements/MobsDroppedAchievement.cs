...
[Serializable]
public class MobsDroppedAchievement
{
    ...
    public MobsDroppedAchievement(int currValue)
    {
    ...
    public MobsDroppedAchievement(AchievementsModel oldModel, SessionDataModel sessionData)
    {
